...
void ASlashCharacter::BeginPlay()
{
	...
	InitializeAdvancedInput(PlayerController);
...
bool ASlashCharacter::CanAttack()
{
	return ActionState == EActionState::EAS_Unoccupied &&
		CharacterState != ECharacterState::ECS_Unequipped && HasEnoughAttackStamina();
}
...
bool ASlashCharacter::HasEnoughAttackStamina()
{
...
void ASlashCharacter::InitializeSlashOverlay(TObjectPtr<APlayerController>& PlayerController)
{
...
void ASlashCharacter::InitializeAdvancedInput(TObjectPtr<APlayerController> PlayerController)
{
	if (PlayerController)
	{
